...
export class ListComponent implements AfterViewInit {
    ...
    ngAfterViewInit() {
        FocusUtility.focusFirstField(<any>null);
    }
}
...
export class List extends PageElement implements IList {
    ...
    public refresh(searchText: string, afterRefreshHandler: () => void) {
        ...
        const dataHandler = (data: any) => {
            ...
            for (const item of data) {
                ...
                const pageElements = this.app.createPageElement(item, this.parentPageElement, <any>null);
        ...
        if (this._url != null) {
            ...
            this.pathService.serverGet(this.app.getBackendUrl(), this.url + urlParameters, listHandlerDoLoad(this), <any>null);
        }
        // mock data
    ...
    public filter() {
        ...
        if (this._searchText && this._searchText === "*") {
            this.refresh(<any>null, <any>null);
            ...
            if (!this._searchText && this.searchRequired) {
                ...
                this.refresh(this._searchText, <any>null);
            } else {
    ...
    public override fromJson(modelElement: { [x: string]: any; }) {
        ...
        if (modelElement["url"] != null) {
            ...
            this.url = KeyUtility.translateUrl(urlString, <any>null, false, this);
        }
