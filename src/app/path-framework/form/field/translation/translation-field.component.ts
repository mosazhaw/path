...
export class TranslationField extends ValueField<any[][]> {
    ...
    private _defaultTranslation: string = <any>null;
    private _translationLabel: string;

    constructor(form: IForm, private pathService: PathService, public override translationService: TranslationService) {
    ...
    public editTranslations() {
        const form: any = this.form.getApp().createDynamicForm();
